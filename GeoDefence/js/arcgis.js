...
("http://services.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer");
    myLayer.id = "BaseMap";
    this.app.map.addLayer(myLayer); app.geometryService = new GeometryService(app.geometryServiceURL);
    app.DrawToolbar = new Draw(app.map); esriConfig.defaults.io.proxyUrl = "/proxy.ashx";
    esriConfig.defaults.io.alwaysUseProxy = false; app.usersGraphicLayer = new GraphicsLayer();
    app.map.addLayer(app.usersGraphicLayer); connect.connect(app.map, "onExtentChange", GetALL);
...
function ActiveDrawtoolBar() {
    app.DrawToolbar.activate("polygon"); app.map.hideZoomSlider();
